			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Boletos</span> - Pagar Boleto</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="Boletos.php" class="breadcrumb-item">Boletos</a>
							<span class="breadcrumb-item active">Pagar Boleto</span>
						</div>
			...
			<div class="content">
				...
				<div class="card bg-grey-300">
					<div class="card-header header-elements-inline">
						<h5 class="card-title font-weight-bold">Pagar Boleto</h5>
						...
						<form action="#">
							<fieldset class="mb-3">
								<div class="form-group row">
									<label class="col-form-label color-black col-lg-2 font-weight-bold">Matricula</label>
									<div class="col-lg-10">
										<input type="number" maxlength="7" class="form-control border-indigo border-2">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label color-black col-lg-2 font-weight-bold">Nombre</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label color-black col-lg-2 font-weight-bold">Carrera</label>
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										<input class="form-control border-indigo border-2" type="date" name="date">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label color-black col-lg-2 font-weight-bold">Ruta</label>
			                            <select class="form-control col-lg-10 border-indigo border-2">
			                                <option value="opt1"><span>Ruta Tamatan</span></option>
			                                <option value="opt2"><span>Ruta Libertad</span></option>
			                            </select>
								</div>

								<div class="form-group row">
									<label class="col-form-label color-black col-lg-2 font-weight-bold">Horario</label>
			                            <select class="form-control col-lg-10 border-indigo border-2">
			                                <option value="opt1"><span>Matutino</span></option>
			                                <option value="opt2"><span>Vespertino</span></option>
			                            </select>
								</div>

							<div class="text-center">
								<button class="btn bg-violet" data-toggle="modal" data-target="#Envio_modal">Pagar Boleto</button>
							</div>
						</form>
					</div>
				</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-violet">
								<h5 class="modal-title">Boleto Comprado</h5>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>

							<div class="modal-body">
								<h5>Ha comprado el boleto de forma correcta</h5>
							</div>
