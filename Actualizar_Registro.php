			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empleados</span> - Actualizar Empleados</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="Actualizar_Registro.php" class="breadcrumb-item">Empleados</a>
							<span class="breadcrumb-item active">Actualizar Empleados</span>
						</div>
			...
			<div class="content">
				...
				<div class="card bg-grey-300">
					<div class="card-header header-elements-inline">
						<h5 class="card-title font-weight-bold">Actualizar Empleados</h5>
						<i class="icon-pencil mr-3 icon-2x"></i>
						...
						<form action="#">
							<fieldset class="mb-3">
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Jotaro">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Kujo">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Practicante">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input class="form-control border-green border-2" type="text" value="21/12/1980">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Jojo@gmail.com">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Japón">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control border-green border-2" value="Tokyo">
									</div>
								</div>
		                        ...
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-lg-5">
			                            <select class="form-control border-green border-2">
							...
							<div class="text-center">
								<button type="submit" class="btn bg-violet">Actualizar <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
